...
_CIPHERPARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='ephemeralpk', full_name='co.upvest.recoverykit.CipherParams.ephemeralpk', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='nonce', full_name='co.upvest.recoverykit.CipherParams.nonce', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recipient', full_name='co.upvest.recoverykit.CipherParams.recipient', index=2,
...
_HASHPARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='len', full_name='co.upvest.recoverykit.HashParams.len', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='m', full_name='co.upvest.recoverykit.HashParams.m', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='p', full_name='co.upvest.recoverykit.HashParams.p', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='salt', full_name='co.upvest.recoverykit.HashParams.salt', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='t', full_name='co.upvest.recoverykit.HashParams.t', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='v', full_name='co.upvest.recoverykit.HashParams.v', index=5,
...
_SEED = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='cipher', full_name='co.upvest.recoverykit.Seed.cipher', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cipherparams', full_name='co.upvest.recoverykit.Seed.cipherparams', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ciphertext', full_name='co.upvest.recoverykit.Seed.ciphertext', index=2,
      number=3, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hash', full_name='co.upvest.recoverykit.Seed.hash', index=3,
      number=4, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hashfunction', full_name='co.upvest.recoverykit.Seed.hashfunction', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hashparams', full_name='co.upvest.recoverykit.Seed.hashparams', index=5,
...
_RECOVERYKIT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='seed', full_name='co.upvest.recoverykit.RecoveryKit.seed', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='seedhash', full_name='co.upvest.recoverykit.RecoveryKit.seedhash', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='username', full_name='co.upvest.recoverykit.RecoveryKit.username', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='datetime', full_name='co.upvest.recoverykit.RecoveryKit.datetime', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='client_ip', full_name='co.upvest.recoverykit.RecoveryKit.client_ip', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='co.upvest.recoverykit.RecoveryKit.version', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user_agent', full_name='co.upvest.recoverykit.RecoveryKit.user_agent', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user_id', full_name='co.upvest.recoverykit.RecoveryKit.user_id', index=7,
...
CipherParams = _reflection.GeneratedProtocolMessageType('CipherParams', (_message.Message,), {
...
HashParams = _reflection.GeneratedProtocolMessageType('HashParams', (_message.Message,), {
...
RecoveryKit = _reflection.GeneratedProtocolMessageType('RecoveryKit', (_message.Message,), {
